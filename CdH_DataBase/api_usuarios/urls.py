...
urlpatterns = [
    ...
    path('mecanico/<int:pk>/', MecanicoDatosDetailView.as_view(), name = 'mecanico-detaiñ'),

    # Despachadores
    path('despacho/', DespachoDatosListCreateView.as_view(), name = 'despacho-list'),
    path('despacho/<int:pk>/', DespachoDatosDetailView.as_view(), name = 'despacho-detail'),

    # Asistencias
    path('asistencia/', AsistenciaListCreateView.as_view(), name = 'asistencia-list'),
    path('asistencia/<int:pk>/', AsistenciaDetailView.as_view(), name = 'asistencia-detail'),
]