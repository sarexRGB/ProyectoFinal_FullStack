...
import { Menu, X, LayoutDashboard, User, ClipboardList, LogOut } from 'lucide-react'
import { Button } from './ui/button'

function EmpleadoSidebar({ isExpanded, toggleSidebar }) {
    ...
    const navItems = [
        { path: '/empleado', label: 'Dashboard', icon: LayoutDashboard },
        { path: '/empleado/perfil', label: 'Perfil', icon: User },
        { path: '/empleado/tareas', label: 'Tareas', icon: ClipboardList },
    ]
        ...
        >
            <div className='flex felx-col'>
                <div className='flex items-center justify-between p-4 border-b border-sidebar-border'>
                    {isExpanded && (
                        <h1 className='text-lg font-bold text-gray-700'>Empleado</h1>
                    )}
